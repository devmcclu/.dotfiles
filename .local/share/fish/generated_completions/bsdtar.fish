...
complete -c bsdtar -l no-safe-writes --description '(x mode only) Do not create temporary files and use rename 2 to replace the o…'
...
complete -c bsdtar -l safe-writes --description '(x mode only) Extract files atomically.'
