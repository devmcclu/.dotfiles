...
complete -c ed2k-link -l hex --description 'Print hash sums in hexadecimal format.'
complete -c ed2k-link -l base32 --description 'Print hash sums in Base32 format.'
complete -c ed2k-link -l base64 --description 'Print hash sums in Base64 format.'
