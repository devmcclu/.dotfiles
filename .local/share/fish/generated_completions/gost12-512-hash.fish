...
complete -c gost12-512-hash -s B -l benchmark --description 'Run benchmark for selected algorithm(s).'
complete -c gost12-512-hash -s C -l crc32 --description 'CRC32: calculate and print CRC32 hash sum.'
complete -c gost12-512-hash -l crc32c --description 'CRC32C: calculate and print CRC32C hash sum.'
complete -c gost12-512-hash -l md4 --description 'MD4: calculate and print MD4 hash sum.'
complete -c gost12-512-hash -s M -l md5 --description 'MD5: calculate and print MD5 hash sum.'
complete -c gost12-512-hash -s H -l sha1 --description 'SHA1: calculate and print SHA1 hash sum.'
complete -c gost12-512-hash -l sha224 -l sha256 -l sha384 -l sha512 --description 'Calculate specified SHA2 hash sum.'
complete -c gost12-512-hash -l sha3-224 -l sha3-256 -l sha3-384 -l sha3-512 --description 'Calculate specified SHA3 hash sum.'
complete -c gost12-512-hash -l tiger --description 'Tiger: calculate and print Tiger hash sum.'
complete -c gost12-512-hash -s T -l tth --description 'TTH: calculate and print DC++ TTH sum.'
complete -c gost12-512-hash -l btih --description 'BTIH: calculate and print BitTorrent Info Hash.'
complete -c gost12-512-hash -s A -l aich --description 'AICH: calculate and print AICH hash.'
complete -c gost12-512-hash -s E -l ed2k --description 'ED2K: calculate and print eDonkey 2000 hash sum.'
complete -c gost12-512-hash -s L -l ed2k-link --description 'eDonkey link: calculate and print eDonkey link.'
complete -c gost12-512-hash -s W -l whirlpool --description 'Whirlpool: calculate and print Whirlpool hash sum.'
complete -c gost12-512-hash -s G -l gost12-256 --description 'GOST-2012: calculate and print 256-bit GOST R 34.'
complete -c gost12-512-hash -l gost12-512 --description 'GOST-2012: calculate and print 512-bit GOST R 34.'
complete -c gost12-512-hash -l gost94 --description 'GOST-94: calculate and print GOST R 34.'
complete -c gost12-512-hash -l gost94-cryptopro --description 'GOST-94-CRYPTOPRO: calculate and print CryptoPro version of the deprecated Ru…'
complete -c gost12-512-hash -l ripemd160 --description 'RIPEMD-160: calculate and print RIPEMD-160 hash sum.'
complete -c gost12-512-hash -l has160 --description 'HAS-160: calculate and print HAS-160 hash sum.'
complete -c gost12-512-hash -l snefru128 -l snefru256 --description 'SNEFRU: calculate and print SNEFRU-128/256 hash sums.'
complete -c gost12-512-hash -l edonr256 -l edonr512 --description 'EDON-R: calculate and print EDON-R 256/512 hash sums.'
complete -c gost12-512-hash -s a -l all --description 'Calculate all supported hash sums.'
complete -c gost12-512-hash -l list-hashes --description 'List names of all supported hashes, one per line.'
...
complete -c gost12-512-hash -s m -l message --description 'Calculate hash sums of the text message.'
...
complete -c gost12-512-hash -s o -l output --description 'Set the file to output calculated hashes and verification results to.'
...
complete -c gost12-512-hash -l gost-reverse --description 'Reverse bytes in hexadecimal output of the GOST hash sum.'
...
complete -c gost12-512-hash -l sfv --description 'Print hash sums in the SFV (Simple File Verification) output format (default).'
complete -c gost12-512-hash -s g -l magnet --description 'Print hash sums formatted as magnet links.'
...
complete -c gost12-512-hash -l hex --description 'Print hash sums in hexadecimal format.'
complete -c gost12-512-hash -l base32 --description 'Print hash sums in Base32 format.'
complete -c gost12-512-hash -l base64 --description 'Print hash sums in Base64 format.'
complete -c gost12-512-hash -l uppercase --description 'Print hash sums in upper case.'
complete -c gost12-512-hash -l lowercase --description 'Print hash sums in lower case.'
