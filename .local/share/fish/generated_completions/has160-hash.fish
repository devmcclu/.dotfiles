...
complete -c has160-hash -l hex --description 'Print hash sums in hexadecimal format.'
complete -c has160-hash -l base32 --description 'Print hash sums in Base32 format.'
complete -c has160-hash -l base64 --description 'Print hash sums in Base64 format.'
