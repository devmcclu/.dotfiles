...
complete -c tiger-hash -l hex --description 'Print hash sums in hexadecimal format.'
complete -c tiger-hash -l base32 --description 'Print hash sums in Base32 format.'
complete -c tiger-hash -l base64 --description 'Print hash sums in Base64 format.'
