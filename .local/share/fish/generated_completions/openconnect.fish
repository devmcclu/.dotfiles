# openconnect
# Autogenerated from man page /usr/lib/jvm/default/man/man8/openconnect.8.gz
...
complete -c openconnect -l force-dpd --description 'Use  INTERVAL as minimum Dead Peer Detection interval (in seconds) for CSTP a…'
...
complete -c openconnect -l passtos --description 'Copy TOS / TCLASS of payload packet into DTLS and ESP packets.'
...
complete -c openconnect -l force-trojan --description 'Use  INTERVAL as interval (in seconds) for repeat execution of Trojan binary …'
...
complete -c openconnect -l cafile --description 'Additional CA file for server verification.'
