# fluidsynth
# Autogenerated from man page /usr/lib/jvm/default/man/man1/fluidsynth.1.gz
...
complete -c fluidsynth -s v -l verbose --description 'Print out verbose messages about midi events (synth.'
