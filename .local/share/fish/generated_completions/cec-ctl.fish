...
complete -c cec-ctl -s D -l driver --description 'Use a cec device that has driver name <drv>, as returned by the CEC_ADAP_G_CA…'
complete -c cec-ctl -s a -l adapter --description 'Use a cec device that has adapter name <adap-name>, as returned by the CEC_AD…'
...
complete -c cec-ctl -s e -l phys-addr-from-edid --description 'Parse the given EDID file (in raw binary format) and extract the physical add…'
complete -c cec-ctl -s E -l phys-addr-from-edid-poll --description 'Parse the given EDID file (in raw binary format) and extract the physical add…'
...
complete -c cec-ctl -l test-power-cycle --description 'This option tests the power cycle behavior of the display.'
complete -c cec-ctl -l stress-test-power-cycle --description 'This option performs a stress test for a display: it power cycles the display…'
