...
complete -c rhash -l hex --description 'Print hash sums in hexadecimal format.'
complete -c rhash -l base32 --description 'Print hash sums in Base32 format.'
complete -c rhash -l base64 --description 'Print hash sums in Base64 format.'
